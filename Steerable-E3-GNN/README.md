...
To run the baseline experiments either use the the official [SEGNN implementation](https://github.com/RobDHess/Steerable-E3-GNN) or set `disable_equivariance` and `use_constrained` to `0`. Note that running the baseline from here will obtain better results than the official implementation, for more details please see [this issue](https://github.com/RobDHess/Steerable-E3-GNN/issues/12).
